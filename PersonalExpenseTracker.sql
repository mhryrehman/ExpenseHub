...
(101, '9', 789, '2024-09-31', 'Medicine'),
(102, '9', 3, '2024-09-31', 'Entertainment'),
(103, '9', 469, '2024-09-29', 'Clothings'),
(104, '9', 985, '2024-09-25', 'Entertainment'),
(105, '12', 3, '2024-09-31', 'Clothings'),
(106, '12', 89, '2024-09-16', 'Bills & Recharges'),
(107, '9', 3, '2024-09-06', 'Clothings'),
(108, '9', 300, '2024-07-04', 'Food'),
(109, '9', 456, '2024-09-01', 'Clothings'),
(110, '9', 3, '2024-09-28', 'Entertainment'),
(111, '9', 300, '2024-09-03', 'Clothings'),
...
(116, '9', 798, '2024-09-04', 'Medicine'),
(117, '9', 45, '2024-09-28', 'Entertainment'),
...
CREATE TABLE `users` (
  ...
  `img` varchar(50) NOT NULL DEFAULT 'default_profile.png'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
(9, 'Yasir', 'Rehman', 'yasir@gmail.com', 'b7161ae9080c2604adb157463312ed47'),
(12, 'Shiza', 'Malik', 'shiza@gmail.com', '25d55ad283aa400af464c76d713c07ad');
